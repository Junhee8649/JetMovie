...
import com.github.junhee8649.jetmovie.ui.components.LoadingView
import com.github.junhee8649.jetmovie.ui.home.components.BodyContent
import com.github.junhee8649.jetmovie.ui.home.components.TopContent
    ...
    LaunchedEffect(key1 = pagerState.currentPage) {
        if (isDragged) {
            ...
            with(pagerState) {
                ...
                // animateScrollToPage()도 쓸 수 있지만 때로는 오류가 발생할 때가 있으므로 그냥 scrollToPage() 사용
                scrollToPage(target)
            }
        }
    }
